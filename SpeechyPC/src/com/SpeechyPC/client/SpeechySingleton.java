	...
	public void registrazione(Utente utente){
		getSpeechService().registrazione(utente, new AsyncCallback<Boolean>() {
			...
			PopupPanel popup = new PopupPanel(true);
				popup.setWidget(new HTML("<font color='red'>Impossibile inserire una nuova registrazione: Errore nella connessione con il server. Per favore riprovare pi� tardi</font>"));
				popup.center();
			 }
			@Override
	...
	public void verificaLogin(){
		getSpeechService().verificaLogin( new AsyncCallback<String>(){
			...
			public void onSuccess(String result) {
				if(result == null){
					PopupPanel popup = new PopupPanel(true);
					popup.setWidget(new HTML("<font color='red'>L'utente non � loggato</font>"));
					popup.center();
				} else {
