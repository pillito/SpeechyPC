...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "speechypc" because\n';
  ...
  $wnd.__gwt_activeModules['speechypc'] = {
    'moduleName' : 'speechypc',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/speechypc.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['speechypc'].superdevmode = true;

  var expectedSuffix = '/speechypc.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + speechypc + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:speechypc';
  var devModeSessionKey = '__gwtDevModeSession:speechypc';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/speechypc/speechypc.nocache.js';
  ...
  $wnd.__gwt_activeModules['speechypc'].canRedirect = true;
  $wnd.__gwt_activeModules['speechypc'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/speechypc?user.agent=' + ua + '&_callback=' + callback;
